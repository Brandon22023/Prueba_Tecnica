...
import employeeRoutes, { createEmployeeRouter } from '../routes/employee.routes.js';
import { ValidationError } from '../models/employee.model.js';

export function createApp({ employeeRouter = employeeRoutes } = {}) {
  const app = express();
  ...
  app.use('/api/empleados', employeeRouter ?? createEmployeeRouter());
